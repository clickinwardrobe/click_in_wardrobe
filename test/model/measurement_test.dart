...
void main() {
  group('Should accurately convert millimetre value to', () {
    ...
    setUp(() {
        asMillis = Measurement(displayName: "test_measurement", valueAsMillis: 500);
    });
    ...
    test('inches given 0', () {
        final Measurement asMillis = Measurement(displayName: "shadowing asMillis so it can be 0", valueAsMillis: 0);
